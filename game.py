...
class Player:
    ...
    def rank_hand(self):
        full_hand = 0
        straight_hand = 0
        for cards in [self.__hand, self.table.table_cards]:
            for card in cards:
...
class Table:
    def __init__(self, pc, chip_levels, starting_worth):
        self.chip_levels = chip_levels.sort()
        self.dealer_index = 0
        ...
        for i in range(pc):
            self.players.append(Player(starting_worth))
        self.players_in = len(self.players)
        self.blinds = [self.chips[0], self.chips[1]]
    ...
    def play_round(self):
        ...
        self.deck = shuffle(self.template_deck) #the deal
    ...
    def player_actions(self):
        ...
        while player_acting != -1:
            ...
            self.players[player_acting].in_this_round += bet
